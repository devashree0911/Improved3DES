public class DES extends Thread{
    ...
    private String enc(String plainText, String key)
    {
        int i;
    ...
    private String dec(String plainText, String key)
    {
        int i;
        String keys[] = getKeys(key);
    ...
    public void start(String s, String k, char c){
        this.s = s;
        this.k = k;
        this.c = c;
        this.start();
    ...
    //     DES d = new DES();
    //     d.start("12345678901234567890123456789012", "12345678901234567890123456789012", 'e');
    //     d.join();
    // }
}
