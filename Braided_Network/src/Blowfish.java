public class Blowfish extends Thread {
    private String S[][]
    ...
    public void start(String pt, String k, char c){
        this.pt = pt;
        this.key = k;
        this.c = c;
        start();
